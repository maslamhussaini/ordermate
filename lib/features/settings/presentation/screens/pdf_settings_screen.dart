...
class _PdfSettingsScreenState extends ConsumerState<PdfSettingsScreen> {
      ...
      body: ListView(
        children: [
          ...
          SwitchListTile(
            ...
            onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(showCurrencySymbol: val)),
          ),
          SwitchListTile(
            title: const Text('Show Decimals'),
            value: _localSettings.showDecimals,
            onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(showDecimals: val)),
          ),
          SwitchListTile(
            title: const Text('Show Organization Name'),
            value: _localSettings.showOrgName,
            onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(showOrgName: val)),
          ),
          SwitchListTile(
            title: const Text('Show Store Name'),
            value: _localSettings.showStoreName,
            onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(showStoreName: val)),
          ),
          SwitchListTile(
            title: const Text('Show Address'),
            value: _localSettings.showAddress,
            onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(showAddress: val)),
          ),
          SwitchListTile(
            title: const Text('Show Phone'),
            value: _localSettings.showPhone,
            onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(showPhone: val)),
          ),
          SwitchListTile(
            title: const Text('Show Logo'),
            value: _localSettings.showLogo,
            onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(showLogo: val)),
          ),
          SwitchListTile(
            title: const Text('Show Amount in Words'),
            value: _localSettings.showAmountInWords,
            onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(showAmountInWords: val)),
          ),
          SwitchListTile(
            title: const Text('Enable Number Formatting'),
            value: _localSettings.enableNumberFormatting,
            onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(enableNumberFormatting: val)),
          ),
          SwitchListTile(
            title: const Text('Show Serial Number'),
            value: _localSettings.showSrNumber,
            onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(showSrNumber: val)),
          ),
          ...
          _buildTextField(
            ...
            onChanged: (val) => _localSettings = _localSettings.copyWith(topNote: val), // Field handle internal state, update object on change
          ...
          _buildTextField(
            ...
            onChanged: (val) => _localSettings = _localSettings.copyWith(bottomNote: val),
          ),
          _buildTextField(
            label: 'Footer Note',
            initialValue: _localSettings.footerNote,
            onChanged: (val) => _localSettings = _localSettings.copyWith(footerNote: val),
          ),
          ...
          _buildDropdown(
            ...
            onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(logoPosition: val)),
          ),
           _buildDropdown(
            ...
            items: const [
              ...
              DropdownMenuItem(value: 'right', child: Text('Top Right')),
              DropdownMenuItem(value: 'center', child: Text('Center')),
              DropdownMenuItem(value: 'after_logo', child: Text('Right of Logo')),
              DropdownMenuItem(value: 'before_logo', child: Text('Left of Logo')), 
              DropdownMenuItem(value: 'below_logo', child: Text('Bottom of Logo')),
            ],
            onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(orgNamePosition: val)),
          ),
           _buildDropdown(
            label: 'Store Name Position',
            value: _localSettings.storeNamePosition,
            items: const [
              DropdownMenuItem(value: 'below_org', child: Text('Below Org Name')),
              DropdownMenuItem(value: 'right_of_org', child: Text('Right of Org Name')),
              DropdownMenuItem(value: 'right_invoice', child: Text('Right of Invoice (Top Right)')),
              DropdownMenuItem(value: 'center', child: Text('Center')),
            ],
            onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(storeNamePosition: val)),
          ),
          _buildDropdown(
            label: 'Address Position',
            value: _localSettings.addressPosition,
            items: const [
              DropdownMenuItem(value: 'below_store', child: Text('Below Store Name')),
              DropdownMenuItem(value: 'top_right', child: Text('Top Right')),
              DropdownMenuItem(value: 'bottom', child: Text('Bottom of Page')),
            ],
            onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(addressPosition: val)),
          ),
          _buildDropdown(
            label: 'Phone Position',
            value: _localSettings.phonePosition,
            items: const [
              DropdownMenuItem(value: 'below_address', child: Text('Below Address')),
              DropdownMenuItem(value: 'top_right', child: Text('Top Right')),
            ],
            onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(phonePosition: val)),
          ),
          ...
          _buildSlider(
             ...
             min: 0, max: 100,
             onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(marginTop: val)),
          ),
           _buildSlider(
             label: 'Bottom Margin',
             value: _localSettings.marginBottom,
             min: 0, max: 100,
             onChanged: (val) => setState(() => _localSettings = _localSettings.copyWith(marginBottom: val)),
          ),
  ...
  Widget _buildDropdown({
    ...
    final effectiveValue = items.map((i) => i.value).contains(value) ? value : items.first.value;
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
