...
abstract class OrderRepository {
  Future<List<Order>> getOrders({int? organizationId, int? storeId, int? sYear});
  ...
  Future<List<Order>> getOrdersByDateRange(DateTime start, DateTime end, {int? organizationId, int? storeId});
